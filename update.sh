#!/bin/bash
ping -c 4 mallplaza.cl && wget http://www.mallplaza.cl/xml/descuentos.php?siteid=mallplaza-norte --output-document=descuentos.xml && sleep 10 && wget http://www.mallplaza.cl/xml/cine.php?siteid=mallplaza-norte --output-document=cine.xml && sleep 10 && wget http://www.mallplaza.cl/xml/eventos.php?siteid=mallplaza-norte --output-document=eventos.xml
ls *.xml >/dev/null || exit
